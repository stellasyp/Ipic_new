...
<div class="container">
	...
	<div class="row clearfix">
		...
		<div class="col-md-8 column">
			<div class="row clearfix">
				<div class="col-md-10 column">
					<img width="600px" src="../home/img/balloon.jpg" class="img-thumbnail" align="left"/>
				</div>
				<div class="col-md-2 column">
					 <a href="#" class="btn btn-info btn-sm" type="button">Button</a>
					  <a href="#" class="btn btn-warning btn-sm " type="button">Button</a> 
					  <a href="#" class="btn btn-sm btn-success" type="button">Button</a>
					   <a href="#" class="btn btn-danger btn-sm " type="button">Button</a>
					 <a href="#" class="btn btn-info btn-sm" type="button">Button</a>
					  <a href="#" class="btn btn-warning btn-sm " type="button">Button</a> 
					  <a href="#" class="btn btn-sm btn-success" type="button">Button</a>
					   <a href="#" class="btn btn-danger btn-sm " type="button">Button</a>
		...
		<div class="col-md-2 column">
			...
			<br><br><br>		
			<a href="../home/pic_list.jsp" class="btn btn-danger btn-block btn-lg" type="button">Save the Pic</a>
